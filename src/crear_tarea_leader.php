...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($nombre_t) && !empty($id_proyecto)) {
        ...
        if ($stmt->execute()) {
            header("Location: tareas_leader.php?id_proyecto=$id_proyecto");
            exit;
        } else {
    ...
    <div class="container">
        ...
        <form method="POST" action="crear_tarea.php?id_proyecto=<?php echo htmlspecialchars($id_proyecto); ?>">
            ...
            <div class="buttons-container">
                ...
                <a href="tareas_leader.php?id_proyecto=<?php echo htmlspecialchars($id_proyecto); ?>" class="back-button">Volver</a>
            </div>
        </form>
    </div>
</body>
