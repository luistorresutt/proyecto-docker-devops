...
<body>
    ...
    <main>
                ...
                <?php while ($row = $tareas_result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td class="actions-button">
                            <a href="editar_tarea_leader.php?id_tarea=<?php echo htmlspecialchars($row['id_tarea']); ?>" class="edit">Editar</a>
                            <a href="eliminar_tarea_leader.php?id_tarea=<?php echo htmlspecialchars($row['id_tarea']); ?>" class="delete">Eliminar</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
        ...
        <a href="crear_tarea_leader.php?id_proyecto=<?php echo htmlspecialchars($id_proyecto); ?>" class="add-task-button">Agregar Tarea</a>
    </main>
</body>
</html>
