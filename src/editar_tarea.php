...
if (!isset($_GET['id_tarea']) || !is_numeric($_GET['id_tarea'])) {
    header('Location: tareas.php?error=ID de tarea no especificado.');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute()) {
        header('Location: tareas.php?id_proyecto=' . $id_proyecto . '&success=Tarea actualizada correctamente.');
        exit;
    } else {
    ...
    <div class="container">
        ...
        <form method="post" action="">
            ...
            <div class="buttons-container">
                ...
                <a href="tareas.php?id_proyecto=<?php echo htmlspecialchars($id_proyecto); ?>" class="back-button"><button type="button">Volver</button></a>
            </div>
        </form>
    </div>
</body>
