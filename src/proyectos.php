...
<body>
    ...
    <main>
            ...
            <tbody>
                <?php while ($row = $proyectos_result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            <a href="tareas.php?id_proyecto=<?php echo htmlspecialchars($row['id_proyecto']); ?>">
                        ...
                        <td class="actions-button">
                            <a href="editar_proyecto.php?id_proyecto=<?php echo htmlspecialchars($row['id_proyecto']); ?>" class="edit">Editar</a>
                            <a href="eliminar_proyecto.php?id_proyecto=<?php echo htmlspecialchars($row['id_proyecto']); ?>" class="delete">Eliminar</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
        ...
        <a href="crear_proyectos.php" class="add-project-button">+</a>
    </main>
</body>
</html>
